...
class Transaction(models.Model):
    ...
    seller = models.ForeignKey(User, on_delete=models.CASCADE, related_name='seller', null=False,
                               limit_choices_to={'role': 'SR'}, default=None)
    customer = models.ForeignKey(User, on_delete=models.CASCADE, related_name='customer', null=False,
...
class Feedback(models.Model):
    id = models.AutoField(primary_key=True)
    seller = models.ForeignKey(User, on_delete=models.CASCADE, related_name='seller_feedback', null=False,
                               limit_choices_to={'role': 'SR'}, default=None)
    customer = models.ForeignKey(User, on_delete=models.CASCADE, related_name='customer_feedback', null=False,
                                 limit_choices_to={'role': 'CR'}, default=None)
    feedback = models.TextField(default=None)
    transaction = models.ForeignKey(Transaction, on_delete=models.CASCADE, related_name='transaction_feedback',
